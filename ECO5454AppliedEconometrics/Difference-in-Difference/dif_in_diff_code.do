...
reg qtr_emp affected_county_after_shock after_2005q3 affected_county year qtr

//second  the total wages in quarter, the dependent variable is total_qtrly_wages
reg total_qtrly_wages affected_county_after_shock after_2005q3 affected_county, r

reg total_qtrly_wages affected_county_after_shock after_2005q3 affected_county

/* becasue the interaction term (i.e., affected_county_after_shock) is not statistically significant,
my assumption that hurricane in 2005 heavily shocked the employment number and total wages are not supported.
